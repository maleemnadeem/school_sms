...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public static final String TABLE_NAME = "config";   // Table Name
    public static final int DATABASE_Version = 1;    // Database Version
    public static final String UID="_id";     // Column I (Primary Key)
    public static final String URL = "url";    //Column II
    public static final String CREATE_TABLE = "CREATE TABLE "+TABLE_NAME+
            " ("+UID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+URL+" VARCHAR(255));";
